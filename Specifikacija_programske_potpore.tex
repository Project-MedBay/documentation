...
\usecase{Pregled podataka o bolesnicima}
	...
	\item \textbf{Opis osnovnog tijeka:}
	\begin{packed_enum}
		\item Djelatnik pretražuje ime bolesnika ili pregledava listu svih bolensika.
...
\usecase{Pregled statistike o djelatnicima i resursima}
	...
	\item \textbf{Opis osnovnog tijeka:}
	\begin{packed_enum}
		\item Privilegirani djelatnik iz kontrolne ploče odabire Pregled statistike o djelatnicima i resursima
